#
#  Be sure to run `pod spec lint SGCalendarTopView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "Classes/SGCalendarTopView", "Classes/SGCalendarTopView/**/*.{h,m}", "Classes/HooDatePicker", "Classes/HooDatePicker/**/*.{h,m}"
